...
## Log-in
- User/mail: ac239494u**xx**@sapexperienceacademy.com - fill **xx** with your user number that you find on your PC; e.g., ac239494u**01**@sapexperienceacademy.com.
- Password: ObyGnrAfdz1!

## SAP Datasphere 
### Space set-up
A space is available and assigned for each participant couple. The space name is AC239494U**xx** (fill **xx** with your user number that you find on your PC; e.g., AC239494U**01**). 
![](../../images/ex0_3.png)
> [!NOTE]  
