...
## SAP Datasphere 
### Space set-up
A space is available and assigned for each participant couple. The space name is `AC239494U**xx**` (fill **xx** with your user number that you find on your PC; e.g., `AC239494U01`). 
![](../../images/ex0_3.png)
> [!NOTE]  
